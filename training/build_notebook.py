#!/usr/bin/env python3
"""Rebuild the Gayatri AI training notebook from scratch (clean version)."""
...
# ── Cell 11: Build quantizer + quantize ──
NB["cells"].append({
    "cell_type": "code",
    "execution_count": None,
    "metadata": {"id": "cell-quantize"},
    "outputs": [],
    "source": [
...
with open("gayatri_training.ipynb", "w") as f:
    json.dump(NB, f, indent=1)

print(f"Notebook rebuilt cleanly with {len(NB['cells'])} cells.")
